                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-7">
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    <div class="card-header"><h3 class="text-center font-weight-light my-4"><img src="../../icons/actions/debug-step-into.png"  class="img-reponsive img-rounded"> Nuevo Proyecto</h3></div>
                                    <div class="card-body">
                                            ...
                                            <div class="form-row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control py-4" id="inputFirstName" type="text" name="proyecto" placeholder="ingrese nombre del proyecto" required/>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label class="small mb-1" for="inputLastName">Desarrollador</label>
                                                        <input class="form-control py-4" id="inputLastName" type="text" name="nombre" placeholder="ingrese el nombre del desarrollador" required/>
                                                    </div>
                                                </div>
                                            </div>
                                             <div class="form-row">
